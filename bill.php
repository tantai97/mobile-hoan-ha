            ...
            <div class="content-r">
                ...
                <div class="nav">
                    <ul class="left">
                        ...
                        <li><span> » </span></li>
                        <li><a class="actived" href="">Cá nhân</a></li>
                        <li><span> » </span></li>
                        <li><a class="actived" href="">Hóa đơn</a></li>
                    </ul>
                    <ul class="right">
                    </ul>
                </div>
                <div class="form-front">
                    <fieldset>
                        ...
                        <p>Bấm vào mã hóa đơn để xem và cập nhật trạng thái hóa đơn.</p>
                        <table cellpadding="5" cellspacing="1" width="100%" class="mobile-price" border="0"
                               style="width:723px;">
                            <tbody>
                            <tr>
                                <th>Mã hóa đơn</th>
                            ...
                            <tr style="font:11px Tahoma;">
                                <td align="center"><a style="display:block; text-align:center;"
                                                      href=""
                                                      title="Xem chi tiết hóa đơn">0007</a></td>
                                <td>03/03/2103</td>
                                <td>3</td>
                                <td style="color:Red;">36,000,000 VNĐ</td>
                                <td>Hóa đơn tạo mới</td>
                                <td>03/03/2103</td>
                            </tr>
                            <tr style="font:11px Tahoma;">
                                <td align="center"><a style="display:block; text-align:center;"
                                                      href=""
                                                      title="Xem chi tiết hóa đơn">0008</a></td>
                                <td>06/06/2110</td>
                                <td>3</td>
                                <td style="color:Red;">42,280,000 VNĐ</td>
                                <td>Hóa đơn tạo mới</td>
                                <td>06/06/2110</td>
                            </tr>
                            </tbody>
